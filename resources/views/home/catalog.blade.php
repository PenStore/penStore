        ...
        <form id="filter_form" action="{{route('catalog')}}" method="get">
            <div class="filter-inner">
                    ...
                    <div class="filter-option" style="position: relative">
                        ...
                        <input type="hidden" name="sort_by" id="sort_by" value="best">
                        <div class="sort_by" style="display:none; position: absolute; right: 10px; top: 100%">
                            <span name="best" class="sort_by_item">Best selling</span>
                            <span name="price_desc" class="sort_by_item">Price: Descending</span>
                            <span name="price_asc" class="sort_by_item">Price: Ascending</span>
                        </div>
                    </div>
            </div>
        </form>
...
let temp_stroke = $('.sort_by_val').html();
...
if(GetURLParameter('sort_by') != undefined){

    
    switch(GetURLParameter('sort_by')){
        case 'best':
            $('.sort_by_val').html('Best selling' + temp_stroke);
            break;
        case 'price_asc':
            $('.sort_by_val').html('Price: Ascending' + temp_stroke);
            break;
        case 'price_asc':
            $('.sort_by_val').html('Price: Descending' + temp_stroke);
            break;
        }
}
...
$('.sort_by_val').click(function(){
    $('.sort_by').toggleClass('active');
});

$('.sort_by_item').click(function(){
    $('.sort_by').toggleClass('active');
    $('.sort_by_val').html($(this).html() + temp_stroke);
